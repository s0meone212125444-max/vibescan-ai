  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#070B16] text-white">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-24 top-[-80px] h-80 w-80 rounded-full bg-[#7C5CFF]/35 blur-3xl" />
        <div className="absolute right-[-120px] top-[180px] h-[22rem] w-[22rem] rounded-full bg-cyan-400/20 blur-3xl" />
        <div className="absolute bottom-[-120px] left-1/2 h-[24rem] w-[24rem] -translate-x-1/2 rounded-full bg-fuchsia-400/20 blur-3xl" />
      </div>

      <section className="relative z-10 mx-auto w-full max-w-6xl px-4 pb-14 pt-8 sm:px-6">
        <div className="grid items-center gap-6 lg:grid-cols-2">
          <div className="rounded-3xl border border-white/20 bg-white/10 p-6 shadow-[0_30px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-8">
            <div className="mb-5">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/try"
                className="rounded-2xl bg-gradient-to-r from-[#7C5CFF] to-[#A18BFF] px-6 py-4 text-center text-base font-bold text-white shadow-[0_14px_40px_rgba(124,92,255,0.45)]"
              >
                Try for Free in 30 Seconds
              </Link>
              <a
                href={CHECKOUT_URL}
                className="rounded-2xl border border-white/25 bg-white/10 px-6 py-4 text-center text-base font-semibold text-white backdrop-blur-xl"
              >
          ...
          <div className="rounded-3xl border border-white/20 bg-white/10 p-4 shadow-[0_30px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-6">
            <div className="rounded-[2rem] border border-white/15 bg-[#0B1224]/85 p-4 shadow-inner shadow-white/5">
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-2xl border border-[#7C5CFF]/35 bg-[#7C5CFF]/15 p-3">
        ...
        <section className="mt-10 grid gap-4 md:grid-cols-3">
          {storyCards.map((card) => (
            <article key={card.label} className="rounded-2xl border border-white/15 bg-white/10 p-5 backdrop-blur-xl">
        ...
        <section className="mt-10 rounded-3xl border border-white/20 bg-white/10 p-5 backdrop-blur-xl sm:p-7">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {testimonials.map((entry) => (
              <article key={entry.name} className="rounded-2xl border border-white/15 bg-[#0B1224]/70 p-4">
